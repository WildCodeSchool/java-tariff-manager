...
Please see the commented section in [Customer.java] to understand what boilerplate code is generated by Lombok, which derives the code from the properties of the class. 
