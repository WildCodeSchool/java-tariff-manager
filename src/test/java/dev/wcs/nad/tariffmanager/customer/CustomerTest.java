...
public class CustomerTest {
    ...
    public void shouldUseCustomerSalesReporting() {
        ...
        // Use Streams for Filtering
        List<Customer> filteredCustomers = CustomerSales.filterCustomersForType(customers, CustomerType.VI);
        assertThat(filteredCustomers.get(0)).isEqualTo(alfred22);

        List<Customer> dateSortedCustomers = CustomerSales.sortByLastPurchase(customers);
        assertThat(dateSortedCustomers.get(0)).isEqualTo(egon54);

        List<Customer> nameSortedCustomers = CustomerSales.sortByName(customers);
